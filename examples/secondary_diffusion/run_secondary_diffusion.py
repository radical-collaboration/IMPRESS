...
from secondary_diffusion import SecondaryDiffusion
...
async def adaptive_criteria(pipeline: SecondaryDiffusion) -> bool:
    """
...
async def adaptive_decision(pipeline: SecondaryDiffusion) -> Optional[Dict[str, Any]]:
    """
...
async def impress_secondary_diffusion() -> None:
    """
