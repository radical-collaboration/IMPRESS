...
_normalize_ligand_atom_names), run against real fixtures already in this
repo -- not synthetic test data.
...
from that run (logs/p{1..4}/*_rfd3/in/guided_scaffold.pdb) are still on
disk and are the primary fixtures used here.
